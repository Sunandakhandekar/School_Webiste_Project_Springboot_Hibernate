        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                ...
                <img class="logo-compact" src="./images/logo-text.jpg" alt="">
                ...
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="addClass">Class</a></li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="classMaster" class="btn btn-primary pl-5 pr-5 mr-3 mb-4"><i class="fa fa-plus" aria-hidden="true"></i>
                                Add New</a>
                            </div>
                            <div class="card-body">
                                            ...
                                            <tr>
                                               <td>${e.class_id}</td>
										        <td>${e.class_name}</td>
                                                  ...
                                                  <td><a href="editClass?id=${e.class_id}" class="btn btn-success"  aria-label="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
													</td>
                                                <td> <a  href="delClass?id=${e.class_id}" class="btn btn-danger"  aria-label="Delete">
