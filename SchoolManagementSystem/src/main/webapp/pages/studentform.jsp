        ...
        ***********************************-->
        <div class="content-body">
            <div class="container-fluid">
                ...
                <!-- row -->
                <form action="student_form" method="post" enctype="multipart/form-data">

                <div class="row">
                    <div class="col-xl-12 col-xxl-12">
                        <div class="card">
                          <h4>New Student Info</h4>
                                        ...
                                        <div>
                                                ...
                                                <div class="col-lg-12 mb-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" name="student_fname"  placeholder="First Name" required>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" name="student_mname"  placeholder="Middle Name" required>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" name="student_lname"  placeholder="Last Name" required>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="number" class="form-control" name="student_mobile"  placeholder="Mobile Number" required>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="file" class="form-control" name="filename"  placeholder="Photo" required>
                                                 ...
                                                 <div class="col-lg-12 mb-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="textarea" class="form-control" name="student_address"  placeholder="Address" required>
                                          ...
                                          <div>
                                                <input type="submit" value="Add" class="btn btn-primary pl-5 pr-5 mr-3 mb-4">
                                                    <a href="studentform" class="btn btn-primary pl-5 pr-5 mr-3 mb-4">Reset</a>
                                                        <a href="studentInfo" class="btn btn-primary pl-5 pr-5 mr-3 mb-4">View StudentInfo</a>
