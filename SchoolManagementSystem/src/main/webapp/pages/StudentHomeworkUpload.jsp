                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="StudentDashboard">Videos</a></li>
                            <li><a href="StudentHomeworkUpload">Homework</a></li>
                                </ul>
                            </li>
                ...
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="StudentHomeworkUpload">HomeworkInfo</a></li>
                        </ol>
                    </div>
                </div>


                 <form action="student_homework_form" method="post">
                <div class="row">
                    <div class="col-xl-12 col-xxl-12">
                        <div class="card">
                          <h4>New Homework Info</h4>
                                        ...
                                        <div>
                                            <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" name="homwork_date" class="form-control" placeholder="Date" required>
                                                    </div>
                                                </div>
                                                </div>    
                                                    <div class="col-lg-12 mb-4">
                                              ...
                                              <div class="col-lg-12 mb-4">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="homework_chapter" class="form-control" placeholder="Chapter Name" required>
                                                    </div>
                                                </div>
                                                </div>
                                                <div class="col-lg-12 mb-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="file"  class="form-control" name="pdf"  placeholder="YouTube Link" required>
                                          ...
                                          <div>
                                                <input type="submit" value="Add" class="btn btn-primary pl-5 pr-5 mr-3 mb-4">
                                                    <a href="StudentHomeworkUpload" class="btn btn-primary pl-5 pr-5 mr-3 mb-4">Reset</a>
