					...
					<div
						...
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active"><a
								href="editHomework">Edit Homework</a></li>
						</ol>
					</div>
				</div>
				<!-- row -->
				<form action="update_homework_info" method="post">
					<div class="row">
								...
								<section>
										...
										<div class="row">
                                                    ...
                                                    <input type="hidden" class="form-control"
														value="${e.homework_id}" name="homework_id" id="emial1"
														placeholder="">
                                                        <label class="text-label">Date</label>
                                                        <input type="date" name="homwork_date" value="${e.homwork_date}" class="form-control" placeholder="Date" required>
                                                    </div>
                                                </div>
                                                </div>    
                                                   <div class="col-lg-12 mb-4">
                                              ...
                                              <div class="col-lg-12 mb-4">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="homework_chapter" value="${e.homework_chapter}" class="form-control" placeholder="Chapter Name" required>
                                                    </div>
                                                </div>
                                                </div>
                                                <div class="col-lg-12 mb-4">
                                                    <div class="form-group">
                                                        <label class="text-label">Pdf File</label>
                                                        <div class="input-group">
                                                            <input type="file"  class="form-control" name="pdf" value="${e.pdf}"  placeholder="YouTube Link" required>
										...
										<div>
											...
											<a href="javascript:void()"
												class="btn btn-primary pl-5 pr-5 mr-3 mb-4">Reset</a> 
												<a href="javascript:void()"
