                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="studentform" class="btn btn-primary pl-5 pr-5 mr-3 mb-4"><i class="fa fa-plus" aria-hidden="true"></i>
                                Add New</a>
                            </div>
                            <div class="card-body">
                                        ...
                                        <thead>
                                         ...
                                         <c:forEach var="e" items="${s1}">
                                            ...
                                            <tr>
										       ...
										       <td> ${e.student_mnane}</td>
										       <td>${e.student_lname}</td>
										        <td>${e.student_mobile}</td>
										        <td>
										        <a><img src="shriyu/${e.student_photo}" width=50px></img></a>
										        </td>
										        <td>${e.student_address}</td>
                                                <td>${e.semail}</td>
										        <td>${e.student_password}</td>
                                                <td>${e.board_name}</td>
                                                <td>${e.class_name}</td>
										        <td>${e.batch_name}</td>
                                                 <td><a href="editStudent?id=${e.student_id}" class="btn btn-success"  aria-label="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
													</td>
                                                <td> <a  href="delStudent?id=${e.student_id}" class="btn btn-danger"  aria-label="Delete">
