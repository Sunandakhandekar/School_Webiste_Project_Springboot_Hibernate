                ...
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="editClass">Class</a></li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                <form action="update_class_master" method="post">
                <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12 mb-4">
                                                    <div class="form-group">
														...
														value="${e.class_id}" name="class_id" id="emial1"
														placeholder="">
                                                            <input type="text" class="form-control" value="${e.class_name}" name="class_name" id="emial1" placeholder="Class Name" required>
