					...
					<div
						...
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active"><a
								href="editVideo">Edit Video</a></li>
						</ol>
					</div>
				</div>
				<!-- row -->
				<form action="update_video_info" method="post">
					<div class="row">
										...
										<div class="row">
                                            <div class="col-lg-12 mb-4">
                                                    ...
                                                    <input type="hidden" class="form-control"
														value="${e.video_id}" name="video_id" id="emial1"
														placeholder="">
                                                        <label class="text-label">Date</label>
                                                        <input type="date" name="video_date" value="${e.video_date}" class="form-control" placeholder="Date" required>
                                                    </div>
                                                </div>
                                                </div>
                                              ...
                                              <div class="col-lg-12 mb-4">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="chapter_name" value="${e.chapter_name}"class="form-control" placeholder="Chapter Name" required>
                                                    </div>
                                                </div>
                                                </div>
                                                <div class="col-lg-12 mb-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="url"  class="form-control" name="youtube_link" value="${e.youtube_link}"  placeholder="YouTube Link" required>
