                ...
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="boardMaster">Board</a></li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="addBoard" class="btn btn-primary pl-5 pr-5 mr-3 mb-4"><i class="fa fa-plus" aria-hidden="true"></i>
                                Add New</a>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="example" class="display" style="min-width: 845px">
                                        ...
                                        <c:forEach var="e" items="${b1}">
										    <tbody>
                                                ...
                                                <td><a href="editBoard?id=${e.board_id}" class="btn btn-success"  aria-label="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
													</td>
                                                <td> <a  href="delBoard?id=${e.board_id}" class="btn btn-danger"  aria-label="Delete">
