        ...
        ***********************************-->
        <div class="content-body">
            <div class="container-fluid">
                ...
                <!-- row -->
                <form action="homework_form" method="post">
                <div class="row">
                                        ...
                                        <div>
                                          ...
                                          <div>
                                                <input type="submit" value="Add" class="btn btn-primary pl-5 pr-5 mr-3 mb-4">
                                                    <a href="homeworkform" class="btn btn-primary pl-5 pr-5 mr-3 mb-4">Reset</a>
                                                        <a href="homeworkInfo" class="btn btn-primary pl-5 pr-5 mr-3 mb-4">View HomeworkInfo</a>
