                ...
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="homeworkOInfo">HomeworkInfo</a></li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="homeworkform" class="btn btn-primary pl-5 pr-5 mr-3 mb-4"><i class="fa fa-plus" aria-hidden="true"></i>
                                Add New</a>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example" class="display" style="min-width: 1092px">
                                        <thead>
                                         ...
                                         <c:forEach var="e" items="${h1}">
                                        
                                        <tbody>
                                            <tr>
                                                <td>${e.homework_id}</td>
                                                <td>${e.homwork_date}</td>
                                                <td>${e.teacher_fname}</td>
                                                <td>${e.class_name}</td>
                                                 <td>${e.board_name}</td>
                                                  <td>${e.subject_name}</td>
                                                <td>${e.homework_chapter}</td>
                                                <td>${e.pdf}</td>
                                                   <td><a href="editHomework?id=${e.homework_id}" class="btn btn-success"  aria-label="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
													</td>
                                                <td> <a  href="delHomework?id=${e.homework_id}" class="btn btn-danger"  aria-label="Delete">
