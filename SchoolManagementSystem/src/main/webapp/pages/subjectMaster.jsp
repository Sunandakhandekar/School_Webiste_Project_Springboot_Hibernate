                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12 mb-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" name="subject_name" class="form-control" id="emial1" placeholder="Subject Name" required>
                                               ...
                                               <div>
                                                <input type="submit" value="Add" class="btn btn-primary pl-5 pr-5 mr-3 mb-4">
                                                    <a href="subjectMaster" class="btn btn-primary pl-5 pr-5 mr-3 mb-4">Reset</a>
                                                        <a href="addSubject" class="btn btn-primary pl-5 pr-5 mr-3 mb-4">View subject</a>
