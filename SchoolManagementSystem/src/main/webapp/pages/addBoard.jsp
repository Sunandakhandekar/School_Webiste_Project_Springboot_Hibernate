                ...
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="addBoard">Board</a></li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                <form action="board_master" method="post">
                <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12 mb-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" name="board_name" id="emial1" placeholder="Board Name" required>
                                               ...
                                               <div>
                                                <input type="submit" value="Add" class="btn btn-primary pl-5 pr-5 mr-3 mb-4">
                                                    <a href="addBoard" class="btn btn-primary pl-5 pr-5 mr-3 mb-4">Reset</a>
                                                        <a href="boardMaster" class="btn btn-primary pl-5 pr-5 mr-3 mb-4">View Board</a>
