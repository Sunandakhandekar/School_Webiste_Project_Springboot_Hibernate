                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="teacherform" class="btn btn-primary pl-5 pr-5 mr-3 mb-4"><i class="fa fa-plus" aria-hidden="true"></i>
                                Add New</a>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example" class="display" style="min-width: 234px">
                                        <thead>
                                            <tr>
                                                <th>Teacher Id</th>
                                        ...
                                        <c:forEach var="e" items="${t1}">
										    <tbody>
										        <tr>
										           ...
										           <td> ${e.teacher_mname}</td>
										           <td>${e.teacher_lname}</td>
										            <td>${e.teacher_mobile}</td>
										            <td>${e.email}</td>
										            <td>${e.teacher_password}</td>
										     <td>   <a><img src="sunanda/${e.teacher_photo}" width=50px></img></a></td>
										            <td>${e.teacher_address}</td>
										            
										            
										            
                                                  <td><a href="editTeacher?id=${e.teacher_id}" class="btn btn-success"  aria-label="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
													</td>
                                                <td> <a  href="delTeacher?id=${e.teacher_id}" class="btn btn-danger"  aria-label="Delete">
